/*
Create 100 crimes. A crime is defined by the Crime.java class
 */
...
public class CrimeLab {
    ...
    public static CrimeLab get(Context con) {
        if (sCrimeLab == null) {
...
//        mCrimes.add(c);
    ...
    public void deleteCrime(ParcelUuid crimeId) {
//        mCrimes.remove(c);
...
//        return mCrimes;
    ...
    public Crime getCrime(ParcelUuid id) {
